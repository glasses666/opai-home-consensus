...
export function createDemoScene() {
  return {
    ...
    rules: [
      ...
      { id: 'rule-cabinet-front-900', kind: 'cabinet-front-clearance', severity: 'warning', minimumMm: 900, source: 'demo' },
      { id: 'rule-tv-distance-1800-3600', kind: 'tv-viewing-distance', severity: 'recommendation', minimumMm: 1800, maximumMm: 3600, source: 'demo' },
      { id: 'rule-tall-storage-anchored', kind: 'child-safety-antitip', severity: 'warning', source: 'demo' },
      { id: 'rule-fixed-equipment-wall-relation', kind: 'fixed-equipment-relation', severity: 'error', source: 'demo' },
    ],
    surfaces: [
