...
SOURCE = ROOT / "01-老师提交正文-Opus5完整版.md"
OUTPUT = ROOT / "01-老师提交正文-Opus5完整版.docx"
EVIDENCE = Path("/Users/dracoglasser/Documents/欧派家居/submission/evidence/raw")
...
def add_cover(doc):
    ...
    p.add_run().add_picture(str(EVIDENCE / "07-product-public-demo.png"), width=Inches(5.6))
    ...
    values = (("参赛队伍", "元界视创"), ("企业命题", "欧派家居企业命题"), ("提交日期", "2026 年 9 月 7 日"))
