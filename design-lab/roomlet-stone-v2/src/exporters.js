...
function buildGLB(data,state='original',animated=false){
 ...
 const g={asset:{version:'2.0',generator:'ROOMLET 02 browser exporter'},scene:0,scenes:[{name:'Roomlet_Stone_02',nodes:[data.root],extras:{layouts:data.layouts,fixedArchitecture:true}}],nodes:[],meshes:[],materials:[],accessors:[],bufferViews:[],buffers:[{byteLength:0}],images:[],textures:[],samplers:[{magFilter:9729,minFilter:9987,wrapS:10497,wrapT:10497}]};
 ...
 g.cameras=[{name:c.name,type:'orthographic',orthographic:{xmag:c.height*.58,ymag:c.height/2,znear:c.near,zfar:c.far}}];g.nodes.push({name:c.name,matrix:Array.from(world),camera:0});g.scenes[0].nodes.push(g.nodes.length-1);
 if(animated){
