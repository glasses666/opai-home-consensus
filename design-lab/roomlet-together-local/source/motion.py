...
if SCENE=='growing':
 ...
 LAYOUTS={
  'original':{'Furniture_Bed':pose(.40,-.50),'Furniture_Wardrobe_A':pose(-1.80,-1.25,P/2),'Furniture_Wardrobe_B':pose(-1.80,.20,P/2),'Furniture_Dresser':pose(.25,1.43),'Furniture_Bedside':pose(1.75,-1.19)},
 ...
 KEYFRAMES={
  'Furniture_Dresser':[(2.70,.25,1.43,0),(3.65,-1.05,1.43,0),(4.10,-1.05,1.12,0),(5.10,-1.05,1.12,P/2),(6.0,-1.80,.95,P/2)],
  'Furniture_Wardrobe_A':[(0,-1.80,-1.25,P/2),(7.7,-1.80,-1.25,P/2)],
  'Furniture_Wardrobe_B':[(1.80,-1.80,.20,P/2),(2.65,-1.80,-.29,P/2)],
  'Furniture_Bed':[(6.05,.40,-.50,0),(6.85,.48,-.50,0)],
  'Furniture_Bedside':[(6.05,1.75,-1.19,0),(6.85,1.81,-1.19,0)]
 }
 FLIGHTS={}
 PHASES=[(0,'衣柜靠墙，床尾另放斗柜'),(1.8,'衣柜沿墙并拢'),(2.7,'斗柜从床尾移向侧墙'),(4.1,'斗柜转向，接入收纳区'),(6.05,'床与床头柜一起贴地微调'),(7.7,'收纳不减，床尾更开阔')]
SMALL=list(FLIGHTS)
BIG=list(KEYFRAMES)
