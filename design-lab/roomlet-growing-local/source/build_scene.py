...
INFO={
 ...
 'together':{'title':'把不同，安放在一起','subtitle':'多一点收纳，也多一点从容。','english':'ROOM FOR BOTH OF YOU','number':'03','accent':'#b9c9c5','originalTitle':'收纳各处添，通道渐渐窄','modifiedTitle':'收纳连成线，空间走得通','originalText':'两座衣柜各占一角，斗柜挡在床尾。东西放下了，走动却变得局促。','modifiedText':'同样的两座衣柜与斗柜沿侧墙组合，床向右后方微调，床侧与床尾一起松开。','metric':'3 组收纳，全部保留','idea':'不是少放谁的东西，而是重新安排彼此的日常。'}
}[SCENE]
