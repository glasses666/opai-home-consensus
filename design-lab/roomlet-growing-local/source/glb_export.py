...
def export_glb(scene: dict, state: str = 'original', animated: bool = False) -> bytes:
    ...
    out={'asset':{'version':'2.0','generator':'ROOMLET Stories / source-authored exporter'},'scene':0,
         'scenes':[{'name':scene['meta']['slug'],'nodes':[scene['root']], 'extras':{'layouts':scene['layouts'],'fixedArchitecture':True,'loopDuration':scene['motion']['duration']}}],
